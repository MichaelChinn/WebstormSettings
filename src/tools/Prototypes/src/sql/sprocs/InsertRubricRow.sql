...
where id = object_id('dbo.InsertFrameworkNodeRubricRow') and sysstat & 0xf = 4)
   BEGIN
      PRINT '.. Dropping sproc InsertFrameworkNodeRubricRow.'
      drop procedure dbo.InsertFrameworkNodeRubricRow
   END
GO
PRINT '.. Creating sproc InsertFrameworkNodeRubricRow.'
GO
CREATE PROCEDURE InsertFrameworkNodeRubricRow
 @pTitle varchar (256)
, @pDescription text
, @pPl1 text
, @pPl2 text

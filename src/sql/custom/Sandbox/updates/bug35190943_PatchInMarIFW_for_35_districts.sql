...
select @bugFixed = 35190943
, @title = 'bug35190943_Patch in marIFW view for 35 districts'
, @comment = 'This version of the update goes into the customization directories, so that it isn''t applied anywhere but production'

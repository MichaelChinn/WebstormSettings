IF exists (SELECT * FROm sysobjects WHERE id = object_id('dbo.GetEvalSessionsForEvaluator_Summary') and sysstat & 0xf = 4)
   BEGIN
      PRINT '.. Dropping sproc GetEvalSessionsForEvaluator_Summary.'
      DROP PROCEDURE dbo.GetEvalSessionsForEvaluator_Summary
   END
GO
PRINT '.. Creating sproc GetEvalSessionsForEvaluator_Summary.'
GO

CREATE PROCEDURE dbo.GetEvalSessionsForEvaluator_Summary

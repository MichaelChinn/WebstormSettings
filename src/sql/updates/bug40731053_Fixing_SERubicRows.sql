...
, @title = 'bug40731053_Fixing_SERubicRows.sql'
, @comment = ''
...
UPDATE [dbo].[SERubricRow]
   SET [PL3Descriptor] = 'The lesson is clearly linked to previous and future lessons. Lessons build on each other in a logical progression.'

...
select @bugFixed = 60469338
, @title = '60469338_sg52to52.sql'
, @comment = 'for 2014 BPRIN frameworks'
/* ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** */
/***********************************************************************************/
/*  Notes...
...
SELECT distinct rubricrowid FROM vframeworkRows vfr
JOIN seframework f ON f.frameworkid = vfr.frameworkid 
WHERE rrshortname = 'sg 5.2' 
AND f.schoolyear = 2014
AND vfr.IsStudentGrowthAligned=0
AND DerivedFromFrameworkName='prin, stateview'
)

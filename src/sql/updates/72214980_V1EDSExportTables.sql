...
select @bugFixed = 72214980
, @title = '72214980_V1EDSExportTables.sql'
, @comment = 'v1 versions of edsRoles, edsUsers'
/* ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** */
/***********************************************************************************/
/*  Notes...
...
CREATE TABLE EDSRolesV1
    (
      PersonId BIGINT ,
      OrganizationName VARCHAR(200) ,
      OSPILegacyCode VARCHAR(20) ,
      OrganizationRoleName VARCHAR(4000)
    )

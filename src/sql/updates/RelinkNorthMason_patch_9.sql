...
select @thisVersion = 9
, @title = 'Relink North Mason rows'
, @comment = 'from scott mail 11/17, 5:42 "database?"'
/* ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** */
/***********************************************************************************/
/*  Notes...
...
delete seRubricRowFrameworkNode where frameworkNodeID =84 and rubricRowID=214
delete seRubricRowFrameworkNode where frameworkNodeID =85 and rubricRowID=216
delete seRubricRowFrameworkNode where frameworkNodeID =85 and rubricRowID=225
delete seRubricRowFrameworkNode where frameworkNodeID =86 and rubricRowID=215

insert seRubricRowFrameworkNode (frameworkNodeID, rubricRowId, sequence) values (84, 225, 860)
insert seRubricRowFrameworkNode (frameworkNodeID, rubricRowId, sequence) values (87, 214, 850)
insert seRubricRowFrameworkNode (frameworkNodeID, rubricRowId, sequence) values (87, 215, 860)
insert seRubricRowFrameworkNode (frameworkNodeID, rubricRowId, sequence) values (87, 216, 870)

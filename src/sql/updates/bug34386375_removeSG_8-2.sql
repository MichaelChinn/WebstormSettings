...
select @bugFixed = 34386375
, @title = 'Remove SG 8.2'
, @comment = 'mail from scott, today, talks about how sg 8.2 should not have made it in'
/* ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** */
/***********************************************************************************/
/*  Notes...
...
--have to get figure out which links to get rid of first...
...
IF @sql_error <> 0
BEGIN
	SELECT @sql_error_message = 'Failed trying remove sg 8.2 rubric rows. In: ' 
		+ @bugFixed

...
select @thisVersion = 6
, @title = 'Evidence Descriptions'
, @comment = ''
/* ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** */
/***********************************************************************************/
/*  Notes...
...
set [Description] = sepRR.[description]

from dbo.SERubricRow seRR
join StateEval_proto.dbo.SERubricRow sepRR on 
	sepRR.Title = seRR.Title and
	sepRR.PL4Descriptor = seRR.PL4Descriptor and
	sepRR.BelongsToDistrict = seRR.BelongsToDistrict

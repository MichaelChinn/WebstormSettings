...
select @thisVersion = 17
, @title = 'Add SEPracticeParticipantGuestRole'
, @comment = ''
/* ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** */
/***********************************************************************************/
/*  Notes...
...
IF NOT EXISTS (SELECT RoleName FROM dbo.aspnet_Roles WHERE ROleName='SEPracticeParticipantGuest')
BEGIN

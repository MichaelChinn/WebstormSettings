...
select @thisVersion = 8
, @title = 'Zap Dup UserDistrictSchool'
, @comment = ''
/* ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** ***UPDATE ME*** */
/***********************************************************************************/
/*  Notes...
...
CREATE TABLE #t (seUserID bigint, districtCode varchar (20)
, schoolCode varchar (20), isPrimary bit)

insert #t (seUserID, districtCode, schoolCode, isPrimary)
select seUserID, districtCOde, schoolCode, isPrimary from dbo.SEUserDistrictSchool
truncate table seUserDistrictSchool

insert SEUserDistrictSchool (seUserID, districtCode, schoolCode, isPrimary)
select distinct seUserID, districtCOde, schoolCode, isPrimary from #t

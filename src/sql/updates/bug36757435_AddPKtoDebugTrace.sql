...
select @bugFixed = 36757435
, @title = 'bug36757435_AddPKtoDebugTrace'
, @comment = ''
...
CREATE TABLE [dbo].[DebugTrace](
	[DebugTraceID] [smallint] IDENTITY(1,1) NOT NULL,
	[KeyCode] [varchar](200) NULL,

...
(function () {
    ...
    authenticationService.$inject = ['$http', '$cookieStore', '$rootScope', 'config'];
    function authenticationService($http, $cookieStore, $rootScope, config) {

        var lastAuthenticatedUser = null;
        ...
        function login(username, password) {
            ...
            /*   return $http.get(config.apiUrl + '/users/247').then(function(response) {
             return response;
             })*/
